...
class ProfileForm2 extends StatefulWidget {
  ...
  ProfileForm2(this.selectedID, this.photoFile, this.drawFile, this.widgetProjectName,
      this.widgetName, this.widgetDetail, this.widgetLocation, this.widgetChecker, this.widgetUploaded);
