...
import 'package:tace_nowait/pages/profileform2.dart';

class PhotoDraw2 extends StatefulWidget {
  ...
  PhotoDraw2(this.selectedID ,this.selectedFile, this.widgetProjectName, this.widgetName, 
      this.widgetDetail, this.widgetLocation, this.widgetChecker, this.widgetUploaded);

  @override
  _PhotoDraw2State createState() => _PhotoDraw2State();
}

class _PhotoDraw2State extends State<PhotoDraw2> {
          ...
          IconButton(
              ...
              onPressed: () async {
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ProfileForm2(
                          widget.selectedID,
                          File(widget.selectedFile.path),
                          drawFile,
                          widget.widgetProjectName,
                          widget.widgetName,
                          widget.widgetDetail,
                          widget.widgetLocation,
                          widget.widgetChecker,
                          widget.widgetUploaded
                          )),
                );
